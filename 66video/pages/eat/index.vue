    ...
    >
      ...
      <view class="header">
        <view class="logo" @click="onClick">
          <image
            class="avatarUrl"
            src="/static/images/left-menu-icon.png"
        ...
        <view v-else class="button">
          <view class="login" @click="toPath('/pages/login/index?type=1')"
            >登录</view
          >
          <view class="register" @click="toPath('/pages/login/index?type=2')"
            >注册</view
          >
        </view>
      </view>
      ...
      <view class="search">
        <input
          ...
          type="text"
          placeholder="搜索视频关键词"
          @click="toPath('/pages/search/index')"
        />
      </view>
      ...
      <tui-tab
        ...
        color="#BBB"
        selectedColor="#D018F5"
        bold
        :tabs="categories"
        scroll
        @change="onClickCategories"
      ></tui-tab>
    ...
    >
      <view class="sort-box" :class="{ 'with-picker': showPicker }">
        ...
        <view class="date-header" @click="showPicker = !showPicker">
          ...
          <image
            src="/static/images/index/icon-down.png"
            mode=""
...
<script>
import { apiGetUserInfo, apiAdList } from "@/common/api/user.js";
